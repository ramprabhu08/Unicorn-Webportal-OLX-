...
<div class="topnav">
  ...
  <form class="form-horizontal" action="laptop.php" method="post">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="battery_status">Battery Status</label>
      <div class="col-sm-10">          
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $query1 = "INSERT INTO Advertisements (itemname,itemtype,dateofinit,dateofexp,ownerid) VALUES ('$productName','$laptop','$today','$expiry','$owner_email')";
      ...
      if($result1){
            ...
            $temp =  $row["advid"];
            $query3 = "INSERT INTO laptop (productid,manufacturer,modelname,yof,batterystatus,expectedprice)
             VALUES ('$temp','$manufacturer','$modelName','$yearOfPurchase','$batteryStatus',$expectedPrice)";
